      ...
      <div className="modal-box">
        ...
        <form onSubmit={submit}>
          <div className="modal-form-grid">
            ...
            <div>
              <label>Marca</label>
              <input className="form-control" name="marca" value={form.marca} onChange={onChange} required />
            </div>
            <div>
              <label>Nombre equipo</label>
              <input className="form-control" name="nombre_equipo" value={form.nombre_equipo} onChange={onChange} required />
            </div>
            <div>
              <label>Serial</label>
              <input className="form-control" name="serial" value={form.serial} onChange={onChange} required />
            </div>
            <div>
              <label>Área</label>
            ...
            <div>
              ...
              <input className="form-control" name="responsable" value={form.responsable} onChange={onChange} />
            </div>
          </div>
          {!row.id && (
