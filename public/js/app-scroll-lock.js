/* Side-effect module: import once to activate modal scroll locking */
(function initScrollLock() {
  ...
  const SELECTORS = [
    '.modal-overlay', '#tr-modal-overlay', '#faqs-modal-overlay',
    '#user-modal', '#acta-modal-overlay', '#smart-scanner-overlay', '#scanner-overlay',
  ].join(',');
