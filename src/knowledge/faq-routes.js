...
router.get('/api/faqs', requireAuth, requirePermission('faqs:read'), wrap(async (req, res) => {
...
router.post('/api/faqs', requireAuth, requirePermission('faqs:create'), wrap(async (req, res) => {
...
router.put('/api/faqs/:id', requireAuth, requirePermission('faqs:edit'), wrap(async (req, res) => {
