...
router.put('/api/reuniones/salas/:id', requireAuth, requirePermission('reuniones:edit'), wrap(async (req, res) => {
...
router.get('/api/reuniones', requireAuth, requirePermission('reuniones:read'), wrap(async (req, res) => {
...
router.post('/api/reuniones', requireAuth, requirePermission('reuniones:create'), wrap(async (req, res) => {
  const {
...
router.post('/api/reuniones/public', wrap(async (req, res) => {
  const {
    sala_id, titulo, tipo, fecha_inicio, fecha_fin,
    organizador_nombre, organizador_correo = '', participantes = [],
    descripcion = '', sede_id = null,
